	...
	<body>
				...
				<div style="width: 100%; height: 300px;  padding-top: 1px; position: relative">
					<div class="tb_box">
						<table class="table table-condensed">
							...
							<tr><td></td></tr>
							<tr><td></td></tr>
							<% for (int i = 0; i < list.size(); i++) {%> <!--헤더 상단부분 거래처정보 데이터를 db를 통해 받아와서 for문으로 뿌려주는 작업  -->
							...
							<%}%>
							 </tbody><!-- tbody는 없는데 닫는tbody는있어요 뭐져? -->
						</table>
					</div>
				</div>
			</div>
		...
		<!--거래처 내역 조회란  -->
			<div id="jb-content1">
				...
				<input class="fromselect" type="button"onClick="termdatesaerchBtn()" value="검색">ㄴ
				<!--  END  -->
			</div>
				...
				<!--거래처내역 상세 테이블  -->					
					...
					<tr class="fixed_top">
						...
						<tbody class="title" id='contentList'>
							...
							<tr><td></td></tr>
							<tr><th></th></tr>
							<%for (int i = 0; i < clientInfoList.size(); i++) {%><!-- 헤더 상단부 거래처 상세내역 전부 땡겨와서 뿌려주는 작업 리플레쉬 or뷰로 넘어 오게되면 바로확인할수있다-->
							<tr>
								<td><%=i + 1%></td>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="accountAf.jsp" method="post">
							...
							전화:<input type="text" name="tel"> <br> 메모<br>
							<textarea rows="10" cols="40" name="memo"></textarea><br> 

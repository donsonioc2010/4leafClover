	...
	<div class="modal-content">
		...
		<!--분리완료후 정렬예정  -->					
			<form action="./addtradeclientAf.jsp" method="get" target="param">
				...
				<div class="clientAdd">우편번호:</div><input class="add"type="text" id="address1" name="address1" readonly="readonly"> <button type="button"  id="" name=""onClick="postNum()"><span class="glyphicon glyphicon-search" aria-hidden="true">찾기</span></button> <br>

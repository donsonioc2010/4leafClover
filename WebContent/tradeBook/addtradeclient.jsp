	...
	<div class="modal-content">
		...
		<!--분리완료후 정렬예정  -->					
			<form action="../account/accountAf.jsp" method="post">	
				...
				우편번호:<input type="text" id="address1" name="address1"> <input type="button" value="찾기" id="" name=""onClick="postNum()"> <br>
				기본주소:<input type="text" id="address2" name="address2" size="50"> <br>
				하위주소:<input type="text" id="address3" name="address3" size="50"><br>
				담당자:<input type="text" name="admin"> 이메일:<input type="text" id="" name="email"> <br> 

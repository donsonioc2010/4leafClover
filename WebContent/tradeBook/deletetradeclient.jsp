...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>거래처 삭제 모달</title>
		<style type="text/css">
			.headDive{margin: 10% auto}
			.headDive .modal-body{height: 500px}
			.headDive .modal-body table th,
			.headDive .modal-body table td{
				text-align: center;
			}
		</style>
	</head>
	...
	<body>
		<div class="modal-dialog headDive">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<!-- 닫기(x) 버튼 -->
					<button type="button"class="close"onclick="modelheaderline()"data-dismiss="modal">
						×
					</button>
				</div>
				<!-- body -->
				<div class="modal-body">
					<div class="serchclass">
						<div class="panel-default">
							<div id="jb-content">
								<div class="componet">
									<form action="./deletetradeclientAf.jsp" method="get"target="param">
										<div class="tb_box"align='center'>
												...
												<tbody class='modals' id='contentList'>
													...
													<%} else {
															for (int i = 0; i < list.size(); i++) {
																dto = list.get(i);
													%>
													<tr class='modals'onclick="companyName('<%=dto.getBuyer_company_name()%>')">
														<td><%=i + 1%></td>

					...
					<div class="input-group-prepend">
						<table class="table table-sm">
							<tr>
								<td scope="col">상호</td>
								<td scope="row">
									<input type="text" class="input" name="companyName" value="<%=dto.getCompanyName()%>">
								</td>
							</tr>
							...
							<tr>
								...
								<td scope="row">
									<input type="text" class="input" name="companyNumber" value="<%=dto.getCompanyNumber()%>">
								</td>
							</tr>
							...
							<tr>
								<td scope="col">업태</td>
								<td scope="row">
									<input type="text" class="input" name="businessCondition" value="<%=dto.getBusinessCondition()%>">
								</td>
							</tr>
							...
							<tr>
								<td scope="col">종목</td>
								<td scope="row">
									<input type="text" class="input" name="businessKind" value="<%=dto.getBusinessKind()%>">
								</td>
							</tr>
							...
							<tr>
								<td scope="col">대표자</td>
								<td scope="row">
									<input type="text" class="input" name="ceo" value="<%=dto.getCeo()%>">
								</td>
							</tr>
							...
							<tr>
								...
								<td scope="row">
									<input type="text" class="input" name="address1" id="address1" value="<%=dto.getAddress1()%>"readonly>
							...
							<tr>
								...
								<td scope="row">
									<input type="text" class="input" name="address2" value="<%=dto.getAddress2()%>" readonly>
								</td>
							</tr>
							...
							<tr>
								<td scope="col"></td>
								<td scope="row">
									<input type="text" class="input" name="address3" value="<%=dto.getAddress3()%>">
								</td>
							</tr>
							...
							<tr>
								<td scope="col">전화</td>
								<td scope="row">
									<input type="text" class="input" name="tel" value="<%=dto.getTel()%>">
								</td>
							</tr>
							...
							<tr>
								...
								<td scope="row">
									<input type="text" class="input" name="phone" value="<%=dto.getPhone()%>">
								</td>
							</tr>
							...
							<tr>
								<td scope="col">이메일</td>
								<td scope="row">
									<input type="text" class="input" name="email" value="<%=dto.getEmail()%>">
								</td>
							</tr>
							<tr>

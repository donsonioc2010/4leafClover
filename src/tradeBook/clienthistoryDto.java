...
public String toString() {
	return "clienthistoryDto [buyerseq=" + buyerseq + ", ledgerproductname=" + ledgerproductname + ", ledgersort="
			+ ledgersort + ", ledgerdate=" + ledgerdate + ", ledgersupplyprice=" + ledgersupplyprice
			+ ", ledgertaxvalue=" + ledgertaxvalue + ", ledgercollectmoney=" + ledgercollectmoney
			+ ", ledgernotcollectmoney=" + ledgernotcollectmoney + ", ledgertotal=" + ledgertotal
			+ ", ledgercompanytotal=" + ledgercompanytotal + ", ledgerordermoney=" + ledgerordermoney + "]";
}

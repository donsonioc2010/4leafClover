...
public class sellerDao {
	...
	public boolean updateSeller(sellerDto dto, String id) {
		String sql = " UPDATE SELLER SET SELLER_COMPANY_NAME=?, "
				+ " SELLER_CEO=?, SELLER_COMPANY_NUMBER=?, SELLER_BUSINESS_CONDITION=?, "
				+ " SELLER_BUSINESS_KIND=?, SELLER_ADDRESS1=?, SELLER_ADDRESS2=?, SELLER_ADDRESS3=?, "
				+ " SELLER_TEL_NUM=?,  SELLER_PHONE_NUM=?, SELLER_EMAIL=?"
				+ " WHERE SELLER_ID=? ";
